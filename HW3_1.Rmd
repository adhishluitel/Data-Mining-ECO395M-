...
```{r 3.1.4.1, echo=FALSE, include=FALSE}
# Do additional stepwise selection based on model1
step(model1, scope = list(lower= null, upper=full), dir="both")
...
Here is the basic information of our random forest model. The whole computational process took less than 3 minutes, and our RMSE is `r round(sqrt(mean(err_save4)), 2)` which is the lowest of all models so far.
